...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002077293491')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+y-CY8PtZLS82ZDE1')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Film_Freakes')
...
URL = "https://enormous-adrian-mlfiles-663da6c6.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://enormous-adrian-mlfiles-663da6c6.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://enormous-adrian-mlfiles-663da6c6.koyeb.app/".format(FQDN)
else:
    URL = "https://enormous-adrian-mlfiles-663da6c6.koyeb.app/".format(FQDN)
